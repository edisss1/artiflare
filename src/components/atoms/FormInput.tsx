...
const FormInput = ({
    ...
    return (
        ...
        >
            ...
            />
            <label
                className="absolute text-nowrap left-3 top-[50%] -translate-y-[50%]  text-[clamp(0.75rem,1.5vw,1rem)] transition-all duration-[250ms] peer-placeholder-shown:top-4 peer-placeholder-shown:text-base  peer-focus:top-0 peer-focus:bg-bg-light  dark:peer-focus:bg-bg-dark  z-40 ps-1 peer-focus:text-sm  text-typography-light dark:text-typography-dark pointer-events-none opacity-70 peer-focus:opacity-100 "
                htmlFor={id}
            >
                {placeholder}
            </label>
