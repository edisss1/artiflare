...
const User = ({ position }: { position?: string }) => {
    ...
    return (
        <Link
            ...
            className={`flex gap-2 items-center self-end justify-center hover:bg-bg-dark/40 w-full max-w-[200px] dark:hover:bg-bg-light/40 py-2 px-2 transition-colors duration-200 ${position} rounded-md items-center flex-col bg-primary dark:bg-primary-dark`}
        >
