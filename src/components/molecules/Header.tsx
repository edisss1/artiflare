...
const Header = () => {
    ...
    return (
        <nav className="flex justify-between relative  max-md:gap-4  w-full  items-center ps-9 max-md:ps-2 py-2  dark:text-typography-dark text-typography-light  rounded-md ">
