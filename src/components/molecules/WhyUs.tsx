...
const WhyUs = () => {
    ...
    return (
        ...
        >
            <h3 className="text-3xl font-bold text-center relative after:content[''] after:w-full after:h-px after:bg-bg-dark dark:after:bg-bg-light after:absolute after:left-0 after:top-[120%]">
                {t("whyUsHeader")}
            </h3>
