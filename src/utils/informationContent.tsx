...
export const informationContent = [
  ...
  },
  {
    ...
    text: "Invite your collaborators with ease. Manage your team, assign roles, and track everyone’s contributions, all within a simple interface that puts productivity and collaboration first.",
    src: management,
  },
  {
